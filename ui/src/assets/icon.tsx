...
export default function Icon({ width, height }: { width: string, height: string }) {
    const { theme } = useContext(ThemeContext);

    return (
        <>
            <svg width={width} height={height} viewBox="0 0 905 688" fill="none" xmlns="http://www.w3.org/2000/svg">
